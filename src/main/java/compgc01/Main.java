...
/**
 * The main class for movie theater booking management application
 *
 * @author Qiong Peng
 * @time 2021
 *
 * References:
 * Codes largely borrowed from work by Filippos Zofakis and Lucio D'Alessandro
