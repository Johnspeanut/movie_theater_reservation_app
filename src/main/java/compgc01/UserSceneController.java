...
public class UserSceneController {
    ...
    void initialize() throws IOException {
        ...
        musicPlaying = false;
        System.out.println("The main path is" + Main.getPath());
        file = new File(URLDecoder.decode(Main.getPath() + "res/sounds/canonInDMajor.mp3", "UTF-8"));
//        Media backgroundMusic = new Media(file.toPath().toUri().getPath());
//        player = new MediaPlayer(backgroundMusic);
    ...
    public void sendEmailClick(ActionEvent event) throws IOException {
        ...
        m.getHostServices().showDocument("mailto:" + "qiongpengcinema@gmail.com");
    }
